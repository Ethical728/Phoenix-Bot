...
//____________________________________________________________________________________________________________________________________________  
  ...
  BOT_INFO: process.env.BOT_INFO || 'ᴘʜᴏᴇɴɪx-ᴍᴅ;ᴀʙʜɪꜱʜᴇᴋ ꜱᴜʀᴇꜱʜ;723220769;https://i.ibb.co/tHWJrz3/IMG-20231128-WA0005.jpg', 
  PREFIX: process.env.PREFIX || '.',
  MODE: process.env.MODE || 'private',
  SUDO: process.env.SUDO || '723220769, 723220769',
  ...
  KOYEB_APP_NAME: process.env.KOYEB_APP_NAME || 'Ethical hacker',
  ...
  AUTO_STATUS_REPLY_MSG: process.env.AUTO_STATUS_REPLY_MSG || '_*Nice Status Bro/bitch 🍀*_',
